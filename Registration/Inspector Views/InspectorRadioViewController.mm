//
//  InspectorRadioViewController.m
//  Registration
//
...
#import "InspectorRadioViewController.h"

@interface InspectorRadioViewController ()
{
    NSMutableArray *currentElements;
}
@end

@implementation InspectorRadioViewController
...
- (IBAction)changeNumberOfElements:(id)sender
{
    ...
    while (numberOfElementsValue > cur)
    {
        ...
        [currentElements addObject:@"Radio"];
        cur++;
    }
